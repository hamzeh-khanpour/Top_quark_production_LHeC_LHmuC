...
C     
C     Process: b mu+ > t vm~ WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,2),I=0,4) /5, 1, 1,-1, 1/
      DATA (NHEL(I,3),I=0,4) /7, 1, 1, 1, 1/
      DATA (NHEL(I,4),I=0,4) /9,-1,-1,-1, 1/
      DATA (NHEL(I,5),I=0,4) /11,-1,-1, 1, 1/
      DATA (NHEL(I,6),I=0,4) /13,-1, 1,-1, 1/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WW) 
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MB,+1,+1*IC(1),W(1,1))  !  count 2
      CALL IXXXXX(P(0,1),MDL_MB,-1,+1*IC(1),W(1,2))  !  count 2
      CALL OXXXXX(P(0,2),MDL_MM,+1,-1*IC(2),W(1,3))  !  count 4
      CALL OXXXXX(P(0,2),MDL_MM,-1,-1*IC(2),W(1,4))  !  count 3
      CALL OXXXXX(P(0,3),MDL_MT,+1,+1*IC(3),W(1,5))  !  count 2
      CALL OXXXXX(P(0,3),MDL_MT,-1,+1*IC(3),W(1,6))  !  count 2
      CALL IXXXXX(P(0,4),ZERO,+1,-1*IC(4),W(1,7))  !  count 7
      CALL FFV2_3(W(1,1),W(1,5),GC_49,MDL_MW,ZERO,W(1,8))  !  count 1
      CALL FFV2_3(W(1,1),W(1,6),GC_49,MDL_MW,ZERO,W(1,9))  !  count 2
      CALL FFV2_3(W(1,2),W(1,5),GC_49,MDL_MW,ZERO,W(1,10))  !  count 2
      CALL FFV2_3(W(1,2),W(1,6),GC_49,MDL_MW,ZERO,W(1,11))  !  count 2
      CALL FFV2P1N_3(W(1,7), W(1,3), GC_40, TMP(1))
      call CombineAmp(4,
     & (/3,2,7,6/), 
     & (/8,9,10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_3(W(1,7), W(1,4), GC_40, TMP(1))
      call CombineAmp(3,
     & (/1,5,4/), 
     & (/9,10,11/),
