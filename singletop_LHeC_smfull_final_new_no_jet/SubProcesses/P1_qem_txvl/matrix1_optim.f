...
C     
C     Process: d~ e- > t~ ve WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,1),I=0,4) /11, 1, 1,-1,-1/
      DATA (NHEL(I,2),I=0,4) /13, 1,-1, 1,-1/
      DATA (NHEL(I,3),I=0,4) /15, 1,-1,-1,-1/
      DATA IDEN/12/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WW) 
      ...
      CALL IXXXXX(P(0,2),MDL_ME,+1,+1*IC(2),W(1,2))  !  count 1
      CALL IXXXXX(P(0,2),MDL_ME,-1,+1*IC(2),W(1,3))  !  count 2
      CALL IXXXXX(P(0,3),MDL_MT,+1,-1*IC(3),W(1,4))  !  count 1
      CALL IXXXXX(P(0,3),MDL_MT,-1,-1*IC(3),W(1,5))  !  count 1
      CALL OXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,6))  !  count 3
      CALL FFV2_3(W(1,4),W(1,1),GC_106,MDL_MW,ZERO,W(1,7))  !  count 1
      CALL FFV2_3(W(1,5),W(1,1),GC_106,MDL_MW,ZERO,W(1,8))  !  count 2
      CALL FFV2P1N_1(W(1,6), W(1,8), GC_40, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/2,3/),
     & TMP, W, AMP(1,1))
      CALL FFV2_0(W(1,3),W(1,6),W(1,7),GC_40,AMP(2,1))  !  count 1
