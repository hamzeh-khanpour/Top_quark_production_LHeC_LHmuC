...
C     
C     
C     Process: b mu+ > t vm~ g [ all = QCD QED ] QCD^2=2 QED^2=4
C     
C     
C     CONSTANTS
C     
...
C     ----------
      ...
      CALL FFV1_2(W(1,1),W(1,5),GC_5,MDL_MB,ZERO,W(1,6))
      CALL FFV2_3(W(1,4),W(1,2),GC_11,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,6),W(1,3),W(1,7),GC_20,AMP(1))
      CALL FFV1_1(W(1,3),W(1,5),GC_5,MDL_MT,MDL_WT,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,1),W(1,6),W(1,7),GC_20,AMP(2))
