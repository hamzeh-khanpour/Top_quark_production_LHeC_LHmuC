...
C      if true.
      ...
      CALL MP_IXXXXX(P(0,1),MDL_MB,NHEL(1),+1*IC(1),W(1,1))
      ...
      CALL MP_FFV2_3(W(1,1),W(1,3),GC_20,MDL_MW,MDL_WW,W(1,5))
C     Amplitude(s) for born diagram with ID 1
      CALL MP_FFV2_0(W(1,4),W(1,2),W(1,5),GC_11,AMP(1))
      CALL MP_FFV2_3(W(1,4),W(1,2),GC_11,MDL_MW,MDL_WW,W(1,6))
C     Counter-term amplitude(s) for loop diagram number 2
      CALL MP_FFV2_0(W(1,1),W(1,3),W(1,6),R2_BXTW,AMPL(1,1))
