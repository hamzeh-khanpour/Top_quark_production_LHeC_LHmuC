...
C      if true.
      ...
      CALL FFV2_3(W(1,1),W(1,3),GC_20,MDL_MW,MDL_WW,W(1,5))
C     Amplitude(s) for born diagram with ID 1
      CALL FFV2_0(W(1,4),W(1,2),W(1,5),GC_11,AMP(1))
      CALL FFV2_3(W(1,4),W(1,2),GC_11,MDL_MW,MDL_WW,W(1,6))
C     Counter-term amplitude(s) for loop diagram number 2
      CALL FFV2_0(W(1,1),W(1,3),W(1,6),R2_BXTW,AMPL(1,1))
