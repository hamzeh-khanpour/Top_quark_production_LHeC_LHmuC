...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,5),W(1,6),GC_40,MDL_MW, FK_MDL_WW,W(1,7))
      CALL FFV2_1(W(1,4),W(1,7),GC_108,MDL_MT, FK_MDL_WT,W(1,6))
      CALL IXXXXX(P(0,7),MDL_MB,NHEL(7),-1*IC(7),W(1,7))
      CALL OXXXXX(P(0,8),MDL_MB,NHEL(8),+1*IC(8),W(1,4))
      CALL IXXXXX(P(0,9),MDL_MC,NHEL(9),-1*IC(9),W(1,5))
      CALL FFV2_3(W(1,5),W(1,4),GC_105,MDL_MW, FK_MDL_WW,W(1,8))
      CALL FFV2_2(W(1,7),W(1,8),GC_49,MDL_MT, FK_MDL_WT,W(1,5))
      CALL FFV1_1(W(1,6),W(1,1),GC_11(IVEC),MDL_MT, ZERO,W(1,8))
      CALL FFV1P0_3(W(1,2),W(1,3),GC_3,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,5),W(1,8),W(1,7),GC_2,AMP(1))
      CALL FFS4_3(W(1,2),W(1,3),GC_89,MDL_MH, ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFS4_0(W(1,5),W(1,8),W(1,4),GC_94,AMP(2))
      CALL FFV2_4_3(W(1,2),W(1,3),GC_50,GC_59,MDL_MZ, ZERO,W(1,9))
