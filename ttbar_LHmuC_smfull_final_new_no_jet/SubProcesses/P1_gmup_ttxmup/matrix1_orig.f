...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1P0_3(W(1,5),W(1,2),GC_3,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,6),W(1,7),GC_2,AMP(1))
      CALL FFS4_3(W(1,5),W(1,2),GC_93,MDL_MH, ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFS4_0(W(1,4),W(1,6),W(1,8),GC_94,AMP(2))
      CALL FFV2_4_3(W(1,5),W(1,2),GC_50,GC_59,MDL_MZ, ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,4),W(1,6),W(1,9),GC_51,GC_58,AMP(3))
      CALL FFV1_2(W(1,4),W(1,1),GC_11(IVEC),MDL_MT, ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,6),W(1,3),W(1,7),GC_2,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFS4_0(W(1,6),W(1,3),W(1,8),GC_94,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_5_0(W(1,6),W(1,3),W(1,9),GC_51,GC_58,AMP(6))
