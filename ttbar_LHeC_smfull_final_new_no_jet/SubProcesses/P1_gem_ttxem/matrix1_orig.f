...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1P0_3(W(1,2),W(1,5),GC_3,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,6),W(1,7),GC_2,AMP(1))
      CALL FFS4_3(W(1,2),W(1,5),GC_89,MDL_MH, ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFS4_0(W(1,4),W(1,6),W(1,8),GC_94,AMP(2))
      CALL FFV2_4_3(W(1,2),W(1,5),GC_50,GC_59,MDL_MZ, ZERO,W(1,9))
