...
C     
C     
C     Process: d mu+ > mu+ t t~ d [ all = QCD QED ] QCD^2=4 QED^2=4
C     Process: s mu+ > mu+ t t~ s [ all = QCD QED ] QCD^2=4 QED^2=4
C     
C     
C     CONSTANTS
C     
...
C     ----------
      ...
      CALL FFV1_1(W(1,4),W(1,7),GC_5,MDL_MT,MDL_WT,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,5),W(1,9),W(1,8),GC_2,AMP(1))
      CALL FFV1_2(W(1,5),W(1,7),GC_5,MDL_MT,MDL_WT,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,10),W(1,4),W(1,8),GC_2,AMP(2))
      CALL FFS1_3(W(1,3),W(1,2),GC_36,MDL_MH,MDL_WH,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFS1_0(W(1,5),W(1,9),W(1,7),GC_37,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFS1_0(W(1,10),W(1,4),W(1,7),GC_37,AMP(4))
      CALL FFV2_4_3(W(1,3),W(1,2),GC_21,GC_24,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 5
      CALL FFV2_5_0(W(1,5),W(1,9),W(1,7),GC_22,GC_23,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_5_0(W(1,10),W(1,4),W(1,7),GC_22,GC_23,AMP(6))
      CALL FFV1P0_3(W(1,5),W(1,4),GC_5,ZERO,ZERO,W(1,10))
      CALL FFV1_2(W(1,1),W(1,8),GC_1,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,5),W(1,6),W(1,10),GC_5,AMP(7))
      CALL FFV1_2(W(1,1),W(1,10),GC_5,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,5),W(1,6),W(1,8),GC_1,AMP(8))
      CALL FFV2_3_2(W(1,1),W(1,7),GC_21,GC_23,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,8),W(1,6),W(1,10),GC_5,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,5),W(1,6),W(1,7),GC_21,GC_23,AMP(10))
C     JAMPs contributing to orders QCD=2 QED=2
      ...
      TMP_JAMP(7) = TMP_JAMP(4) +  TMP_JAMP(3)  ! used 2 times
      TMP_JAMP(6) = TMP_JAMP(2) +  TMP_JAMP(1)  ! used 2 times
      TMP_JAMP(8) = TMP_JAMP(6) +  TMP_JAMP(5)  ! used 2 times
      TMP_JAMP(9) = TMP_JAMP(8) +  TMP_JAMP(7)  ! used 2 times
      JAMP(1,1) = (5.000000000000000D-01)*TMP_JAMP(9)
      JAMP(2,1) = (-1.666666666666667D-01)*TMP_JAMP(9)
