...
C     
C     
C     Process: g mu+ > mu+ t t~ [ all = QCD QED ] QCD^2=4 QED^2=4
C     
C     
C     CONSTANTS
C     
...
C     
     ...
     $  NSQAMPSO), FIRSTTIME
      ...
      DOUBLE PRECISION AMP2B(6), JAMP2B(0:1,0:NAMPSO)
...
C     GLOBAL VARIABLES
C     
      DOUBLE PRECISION AMP2(6), JAMP2(0:1,0:NAMPSO)
      COMMON/TO_AMPS_BORN/  AMP2,       JAMP2
      DOUBLE COMPLEX SAVEAMP(NGRAPHS,MAX_BHEL)
      COMMON/TO_SAVEAMP/SAVEAMP
      DOUBLE PRECISION HEL_FAC
...
C           Amplitude(s) for diagram number 2
            ...
            CALL FFV2_4_3(W(1,3),W(1,2),GC_21,GC_24,MDL_MZ,MDL_WZ,W(1
     $       ,9))
C           Amplitude(s) for diagram number 3
            CALL FFV2_5_0(W(1,5),W(1,6),W(1,9),GC_22,GC_23,AMP(3))
            CALL FFV1_2(W(1,5),W(1,1),GC_5,MDL_MT,MDL_WT,W(1,6))
C           Amplitude(s) for diagram number 4
            CALL FFV1_0(W(1,6),W(1,4),W(1,7),GC_2,AMP(4))
C           Amplitude(s) for diagram number 5
            CALL FFS1_0(W(1,6),W(1,4),W(1,8),GC_37,AMP(5))
C           Amplitude(s) for diagram number 6
            CALL FFV2_5_0(W(1,6),W(1,4),W(1,9),GC_22,GC_23,AMP(6))
            DO I=1,NGRAPHS
