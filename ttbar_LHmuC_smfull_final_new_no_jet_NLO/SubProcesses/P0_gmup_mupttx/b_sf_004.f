...
C     JAMPs contributing to orders QCD=1 QED=2
      JAMP2(1,1) = (1.666666666666667D-01)*AMP(1)+(1.666666666666667D
     $ -01)*AMP(2)+(1.666666666666667D-01)*AMP(3)+(1.666666666666667D
     $ -01)*AMP(4)+(1.666666666666667D-01)*AMP(5)+(1.666666666666667D
     $ -01)*AMP(6)
      DO I = 1, NSQAMPSO
        ANS(I) = 0D0
      ENDDO
