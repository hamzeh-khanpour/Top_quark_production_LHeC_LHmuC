...
C     JAMPs contributing to orders QCD=1 QED=2
      JAMP1(1,1) = AMP(1)+AMP(2)+AMP(3)+AMP(4)+AMP(5)+AMP(6)
C     JAMPs contributing to orders QCD=1 QED=2
      JAMP2(1,1) = (6.666666666666666D-01)*AMP(1)+(6.666666666666666D
     $ -01)*AMP(2)+(6.666666666666666D-01)*AMP(3)+(6.666666666666666D
     $ -01)*AMP(4)+(6.666666666666666D-01)*AMP(5)+(6.666666666666666D
     $ -01)*AMP(6)
      DO I = 1, NSQAMPSO
        ANS(I) = 0D0
      ENDDO
